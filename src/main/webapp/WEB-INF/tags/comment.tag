...
<div id="comments_${newsItem.id}" style="display: none">
    <c:forEach var="comment" items="${newsItem.comments}">
        ...
        <div class="comment">
            <p><c:out value="${comment.content}"/> -
                ...
                <sec:authorize access="hasRole('ADMIN')">
                    <a href="comment_${comment.id}" class="showEditComment"><spring:message
                            code="button.update"/></a>&NonBreakingSpace;|&NonBreakingSpace;<a href="/news/deleteComment.html?commentId=${comment.id}&newsId=${newsItem.id}" class="deleteComment" data-toggle="tooltip" data-placement="top"><spring:message
            ...
            <div id="comment_${comment.id}" class="editCommentDiv" style="display: none">
                ...
                <a href="/news/editComment.html?commentId=${comment.id}&newsId=${newsItem.id}" data-toggle="tooltip"
    ...
    <sec:authorize access="isAuthenticated()">
        <div class="collapse addCommentDiv" id="comment${newsItem.id}">
            ...
            <a href="/news/addComment.html?newsId=${newsItem.id}" data-toggle="tooltip" data-placement="top"
